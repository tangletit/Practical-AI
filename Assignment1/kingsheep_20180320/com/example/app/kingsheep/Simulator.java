package com.example.app.kingsheep;
...
public class Simulator {
               ...
               InvocationTargetException
    {
        ...
        String pack = "com.example.app.kingsheep.team." + teamName + ".";
    ...
    private void loadImages() {
        gfx        = new Gfx();
        imgEmpty   = loadImage("com/example/app/gfx/empty.png");
        imgSheep1  = loadImage("com/example/app/gfx/sheep1.png");
        imgSheep2  = loadImage("com/example/app/gfx/sheep2.png");
        imgWolf1   = loadImage("com/example/app/gfx/wolf1.png");
        imgWolf2   = loadImage("com/example/app/gfx/wolf2.png");
        imgGrass   = loadImage("com/example/app/gfx/grass.png");
        imgRhubarb = loadImage("com/example/app/gfx/rhubarb.png");
        imgSkigard = loadImage("com/example/app/gfx/skigard.png");
    }
