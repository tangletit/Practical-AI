...
def a_star_search(graph, start, goal):
    ...
    while not frontier.empty():
        ...
        for next in graph.neighbors(current):#搜索当前点附近的点
            new_cost = cost_so_far[current] + graph.cost(current, next) #路径代价为
...
start, goal = (1, 4), (7, 8)
came_from, cost_so_far,all_cost = a_star_search(diagram4, start, goal)
print(came_from)
print(cost_so_far)
print(all_cost)
...
print()
draw_grid(diagram4, width=3, number=all_cost, start=start, goal=goal)
print()
